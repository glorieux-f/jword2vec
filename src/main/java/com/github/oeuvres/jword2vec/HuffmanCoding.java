 ...
 * <p>
 * Note that the generated codes and the index of the parents are both used in
 * the hierarchical softmax portions of the neural network training phase
 * <p>
 */
public class HuffmanCoding
{
    ...
    /**
     * Populate the count, binary, and parentNode arrays with the Huffman tree This
     * uses the linear time method assuming that the count array is sorted
     */
    ...
    /**
     * @return Ordered map from each token to its {@link HuffmanNode}, ordered by
