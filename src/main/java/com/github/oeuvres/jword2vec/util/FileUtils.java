...
public final class FileUtils
{
    ...
    /**
     * Returns a subdirectory of a given directory; the subdirectory is expected to
     * already exist.
     * 
     * @param parent the directory in which to find the specified subdirectory
     * @param item   the name of the subdirectory
     * @return the subdirectory having the specified name; null if no such directory
     *         exists or exists but is a regular file.
     */
    ...
    /**
     * @return File for the specified directory, creates dirName directory if
     *         necessary.
     * @throws IOException if there is an error during directory creation or if a
     *                     non-directory file with the desired name already exists.
     */
    ...
    /**
     * @return File for the specified directory; parent must already exist, creates
     *         dirName subdirectory if necessary.
     * @throws IOException if there is an error during directory creation or if a
     *                     non-directory file with the desired name already exists.
     */
    ...
    /**
     * @return File for the specified directory; parent must already exist, creates
     *         all intermediate dirNames subdirectories if necessary.
     * @throws IOException if there is an error during directory creation or if a
     *                     non-directory file with the desired name already exists.
     */
    ...
    /**
     * Deletes a file or directory. If the file is a directory it recursively
     * deletes it.
     * 
    ...
    /**
     * @return A random temporary folder that can be used for file-system operations
     *         testing
     */
    public static File getRandomTemporaryFolder(String prefix, String suffix)
    {
        return new File(System.getProperty("java.io.tmpdir"),
                Strings.nullToEmpty(prefix) + UUID.randomUUID().toString() + Strings.nullToEmpty(suffix));
    }
}
