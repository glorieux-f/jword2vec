...
public class Strings
{
     ...
     *         non-zero trimmed length; <code>false</code> otherwise
     */
    ...
    /**
     * Join the toString of each object element into a single string, with each
     * element separated by the given sep (which can be empty).
     */
    ...
    /**
     * @return The concatenation of toString of the objects obtained from the
     *         iterable, separated by sep, and if max is > 0 include no more than
     *         that number of objects. If wrap is non-null, prepend and append each
     *         object with it
     */
